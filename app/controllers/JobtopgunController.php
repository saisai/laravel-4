...
class JobtopgunController extends BaseController {
  ...
  public function showIndex()
	{
			...
			$jobsdb = DB::table('tb_jobtopgun')->orderBy('time', 'desc')->paginate(200); 
			 return View::make('jobsdb.index')
				->with('title', 'Data collected from jobtopgun.com')
				->with('jobsdb', $jobsdb);
